...
public interface IPuffle {
	 ...
	 */
	void applyAccleration(float accelerationX,
			float accerlationY);
	 ...
	 */
	void scaleVelocity(float scaleX, float scaleY);
	 ...
	 * @param scale The scalar.
	 */
	void scaleAccleration(float scale);
}